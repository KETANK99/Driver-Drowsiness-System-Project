...
class register:
    ...
    def register_data(self):
        ...
        if self.txt_fname.get() == "" or self.txt_lname.get() == "" or self.txt_Email.get() == "" or self.txt_address.get() == "" or self.txt_contact.get() == "" or self.txt_pin.get() == "" or self.txt_password.get() == "" or self.txt_cpass.get() == "":
            ...
            try:
                con = pymysql.connect(host="127.0.0.1", user="root", password="Root@123", database="dml")
                cur = con.cursor()
                cur.execute(
                    "insert into user (f_name,l_name,Email,address,contact,pin,password) values(%s,%s,%s,%s,%s,%s,%s)",
